...
class MainControllerTest < Test::Unit::TestCase
  ...
  def generic_test_add_requestparameter (name, id)
    ...
    assert_select_rjs do
      ...
      assert_select "div.request-#{name}-field > div", 8 
  ...
  def generic_test_set_cookieparameter_name (model, name, id, value)
    ...
    assert_select_rjs do
      ...
      assert_select "div.request-cookieparameter-field > div", 8 
  ...
  def generic_test_set_postparameter_name (model, name, id, value)
    ...
    assert_select_rjs do
      ...
      assert_select "div.request-postparameter-field > div", 8
      # with this we are quite sure we got a real postparameter item. so this will do
    end
  end
  ...
  def generic_test_set_querystringparameter_name (model, name, id, value)
    ...
    assert_select_rjs do
      ...
      assert_select "div.request-querystringparameter-field > div", 8
